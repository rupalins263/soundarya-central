        ...
        <div className="page-content">
            <div className="row page-row">
                <div className="jobs-wrapper col-md-8 col-sm-7">  
                    ...
                    <img src="https://res.cloudinary.com/dvl9i5pry/image/upload/v1506077424/Recruitment_b0dzjc.jpg"/><br/><br/>

                    <img src="https://res.cloudinary.com/dvl9i5pry/image/upload/v1506077467/careers_wpwrwl.jpg"/><br/>
