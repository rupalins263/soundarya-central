            ...
            <div className="row page-row">
                <article className="welcome col-md-8 col-sm-7">                                                    
                    ...
                    <ul className="icons-list star">
                        <li>All pupils of the school are members of the Library.</li>
                        <li>Strict discipline and silence is to be observed in the Library and reading room.</li>
                        <li>Students can borrow one book at a time.</li>
                        <li>Library books can be issued and returned during library period of the grade only and not in any teaching period.</li>
                        <li>Library books should be properly looked after and deposited on the due date.</li>
                        <li>Marking, underlining, cutting and erasing or dog – airing pages of the books are strictly prohibited and liable to be punished if any such damage to library books is detected by the Librarian.</li>
                        <li>The Librarian may recall a book, at any time in any case of urgency.</li>
                        <li>Library Books are to be deposited at least one week before leaving the station or any break, and one month before any vacation.</li>
                        <li>No Dues certificate for each pupil is to be obtained from the Librarian while withdrawing any student from the school.</li>
